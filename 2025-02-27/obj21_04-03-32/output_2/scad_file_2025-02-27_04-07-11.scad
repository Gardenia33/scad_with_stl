...
cylinder_height = 120; // Increased height for a more extended cylindrical body
flange_diameter = 70;
flange_thickness = 10; // Increased thickness for better definition
spacer_thickness = 6; // Adjusted for proper spacing
bolt_diameter = 5;
bolt_length = 12; // Shortened to match the original model
nut_diameter = 8;
nut_thickness = 4;
bolt_hole_radius = 3;
num_bolts = 10; // Increased number of bolts to match the original model
bolt_circle_radius = 32;
