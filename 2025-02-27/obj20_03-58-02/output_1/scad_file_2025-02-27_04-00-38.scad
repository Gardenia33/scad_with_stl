...
shaft_length = 50;
shaft_diameter = 10;
hub_diameter = 15; // Reduced to match the original model
hub_length = 10; // Reduced to match the original model
flange_diameter = 25; // Adjusted to match the original model
flange_thickness = 2; // Reduced to match the original model
spacer_diameter = 23; // Adjusted to match the original model
spacer_thickness = 2;
bolt_diameter = 3;
bolt_length = 20;
nut_diameter = 6;
nut_thickness = 3;
bolt_hole_radius = 8; // Adjusted to match the original model
...
module coupling() {
    ...
    // Central shaft (added to match the original model)
    ...
    // Bolts and nuts (added to match the original model)
    for (i = [0:90:270]) {
        rotate([0, 0, i]) {
