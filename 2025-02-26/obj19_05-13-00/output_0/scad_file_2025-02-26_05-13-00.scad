...
module bolt_with_nut() {
    union() {
        ...
        translate([0, 0, bolt_length / 2])
            cylinder(d=bolt_diameter * 1.5, h=bolt_diameter / 2, center=true);
    }
}

// Function to create the central craft
...
// Function to create the input and output crafts
