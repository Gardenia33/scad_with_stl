...
// Module for central shaft with a more pronounced middle section
...
// Module for spacer ring with a more visible structure
module spacer_ring() {
    difference() {
...
// Module for flange plate with bolt holes and proper separation
module flange_plate() {
    difference() {
...
// Assembly with proper spacing and distinct components
