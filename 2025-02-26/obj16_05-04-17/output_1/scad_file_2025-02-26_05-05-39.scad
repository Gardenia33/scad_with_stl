...
// Parameters
hub_diameter = 30;
hub_length = 35; // Reduced to match the original model
shaft_hole_diameter = 10;
flange_diameter = 60;
flange_thickness = 4; // Reduced to make it more distinct
bolt_hole_diameter = 5;
bolt_circle_diameter = 50;
spacer_thickness = 3; // Adjusted to make it more visible
bolt_length = 22; // Increased slightly to ensure bolts are distinct
bolt_diameter = 5;
nut_size = 8;
nut_thickness = 4;
